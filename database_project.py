#
#Import the libraries and github modules in the programm
...
class product_ui:
    ...
    def __init__(self,root):
        ...
        #Create a function to display aviable products in scroll bar
        def ShowProductList():
        ...
        #Create a function to scrollbar to display the exact datapoint
        ...
        #Create a function to delete the products data points from DB
        def del_recod():
...
#############################################################################
        ...
        LeftSideFrame=LabelFrame(UiBodyFrame, bd=2, width=600, 
                                height = 400, padx=30, pady=10, bg='ivory', fg='navy',
        ...
        self.labelp_cont= Label(LeftSideFrame, 
                                   font=('Times New Roman',12, 'bold'),
                                  text = 'Company Contact:', padx = 2,pady=2,
                                  bg = 'ivory', fg = 'firebrick')
